...
from .constants import ExperimentState, LOG_LINE_PATTERN, EPOCH_LINES, \
    ...
    def has_no_results(self) -> bool:
        ...
        if self._has_no_results is None:
            if self._best_epoch is not None:
                ...
                last_line = ExpLogLine(self.lines[-1])
                self._has_no_results = (last_line.exp_state == ExperimentState.START) or (
                            last_line.exp_state == ExperimentState.CONFIG)
